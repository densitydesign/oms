(function(){
  ...
  who.graph = function(){
    ...
    var width = 600,
      ...
      colorScale = d3.scale.ordinal().domain(["1","4","13","9","14","0","8","12","5","3","15","11","7"]).range(["#42A5B3","#E3BA22","#F6B656","#005D6E","#E25A42","#6BBBA1","#9A3E25","#5C8100","#A0B700","#8E6C8A","#137B80","#BA5F06","#BD8F22"]),
      _state = {},
      _currentView,
      _s,
      _graph,
