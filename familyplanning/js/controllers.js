...
angular.module('who.controllers', [])
  .controller('familyplanning', function($scope, $window, cfpLoadingBar) {
    ...
    $scope.sections = [
      ...
      {id:"fp_query_intro",label: "The web corpus", nav: true, step:false, template:"sub-chapter", protocol: 'fp_web'},
      {id:"fp_query_network",label: "The web corpus",nav: false,step:true, template:"viz-step", protocol: 'fp_web', legend:true},
      {id:"fp_query_analytics",label: "The web corpus",nav: false, step:false, template:"analytics", protocol: 'fp_web'},
      {id:"fp_crawl_intro", label:"The web cartography", nav: true, step:false, template:"sub-chapter", protocol: 'fp_web'},
      {id:"fp_crawl_network", label:"The web cartography", nav: false, step:true, template:"viz-step", protocol: 'fp_web', legend:true},
      {id:"fp_text_intro",label:"The Issue analysis",nav: true, step:false,template:"sub-chapter", protocol: 'fp_text'},
      ...
      {id:"fp_wiki_edits_stacked",label:"The geology of Wikipedia", nav: false, step:false, template:"wiki-edits", protocol: 'fp_wiki'},
      {id:"fp_wiki_users_intro",label:"Many authors, many conflicts",nav: true,step:false, template:"sub-chapter", protocol: 'fp_toc'},
